...
# >> 숫자를 입력하세요: 30
# 40
inp_val = input("숫자를 입력하세요 : ")
print(int(inp_val)+10)

# 113
# 사용자로부터 하나의 숫자를 입력 받고 짝수/홀수를 판별하라.
# >> 30
# 짝수
inp_val = input("input nums : ")
if int(inp_val) % 2 == 0:
    print("짝수")
else:
    print("홀수")
...
# # >> 좋아하는 과일은? 사과
# # 정답입니다.
inp_fruit = input("좋아하는 과일은? ")
if inp_fruit in fruit:
    print("Correct")
else:
    print("Wrong")
...
inp_comp = input("what corp u want :")
if inp_comp in warn_investment_list:
    print("Warning")
else:
    print("Not Warning...")
...
# # >> 제가좋아하는계절은: 봄
# # 정답입니다.
inp_fruit = input("what season u like : ")
if inp_fruit in fruit.keys():
    print("Correct")
else:
    print("Wrong")
...
# >> 좋아하는과일은? 한라봉
# 오답입니다.
inp_fruit = input("what fruit u like : ")
if inp_fruit in fruit.values():
    print("Correct")
else:
    print("Wrong")
